...
export const Sanhua: Character = {
  ...
  StatsWeights: {
    ...
    [StatType.ENERGY_REGENERATION]: 0.4,
    [StatType.BASIC_ATTACK_DMG_AMPLIFICATION]: 0.8,
    [StatType.HEAVY_ATTACK_DMG_AMPLIFICATION]: 0.6,
    [StatType.RESONANCE_LIBERATION_DMG_AMPLIFICATION]: 0.3,
    [StatType.RESONANCE_SKILL_DMG_AMPLIFICATION]: 0.3,
