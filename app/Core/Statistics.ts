...
export const SUB_STAT_VALUES: Record<StatType, number[]> = {
  ...
  [StatType.HP_PERCENTAGE]: [6.4, 7.1, 7.9, 8.6, 9.4, 10.1, 10.9, 11.6],
  [StatType.HEALING_BONUS]: [],
  [StatType.DEF]: [40, 50, 60, 70],
  [StatType.DEF_PERCENTAGE]: [8.1, 9.0, 10.0, 10.9, 11.8, 12.8, 13.8, 14.7],
  [StatType.ENERGY_REGENERATION]: [6.8, 7.6, 8.4, 9.2, 10, 10.8, 11.6, 12.4],
  [StatType.BASIC_ATTACK_DMG_AMPLIFICATION]: [6.4, 7.1, 7.9, 8.6, 9.4, 10.1, 10.9, 11.6],
  [StatType.HEAVY_ATTACK_DMG_AMPLIFICATION]: [6.4, 7.1, 7.9, 8.6, 9.4, 10.1, 10.9, 11.6],
  [StatType.RESONANCE_LIBERATION_DMG_AMPLIFICATION]: [6.4, 7.1, 7.9, 8.6, 9.4, 10.1, 10.9, 11.6],
...
export const FOUR_COST_SECONDARY_STATS_VALUES: Record<StatType, number> = {
  [StatType.ATTACK]: 150,
  [StatType.NONE]: 0,
  [StatType.CRIT_DMG]: 0,
  [StatType.CRIT_RATE]: 0,
...
export const THREE_COST_SECONDARY_STATS_VALUES: Record<StatType, number> = {
  [StatType.ATTACK]: 100,
  [StatType.NONE]: 0,
  [StatType.CRIT_DMG]: 0,
  [StatType.CRIT_RATE]: 0,
...
export const ONE_COST_SECONDARY_STATS_VALUES: Record<StatType, number> = {
  [StatType.ATTACK]: 0,
  [StatType.NONE]: 0,
  [StatType.CRIT_DMG]: 0,
  [StatType.CRIT_RATE]: 0,
...
export function IsSecondaryStatType(type: StatType, echoCost: EchoCost): boolean {
  switch (echoCost) {
    case EchoCost.FOUR_COST:
      return FOUR_COST_SECONDARY_STATS_VALUES[type] !== 0
    case EchoCost.THREE_COST:
      return THREE_COST_SECONDARY_STATS_VALUES[type] !== 0
    case EchoCost.ONE_COST:
      return ONE_COST_SECONDARY_STATS_VALUES[type] !== 0
    default:
      return false
  }
}
