...
export const Rime_Draped_Sprouts: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Rime-Draped_Sprouts.webp',
  Rarity: Rarity.FIVE_STARS,
  Type: WeaponType.RECTIFIER,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Stellar_Symphony: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Stellar_Symphony.webp',
  Rarity: Rarity.FIVE_STARS,
  Type: WeaponType.RECTIFIER,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Verdant_Summit: Weapon = {
  ...
  Name: 'Verdant Summit',
  Level: 90,
  Icon: 'Weapon_Verdant_Summit.webp',
  Rarity: Rarity.FIVE_STARS,
  Type: WeaponType.BROADBLADE,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Call_of_the_Abyss: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Call_of_the_Abyss.webp',
  Rarity: Rarity.FOUR_STARS,
  Type: WeaponType.RECTIFIER,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Celestial_Spiral: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Celestial_Spiral.webp',
  Rarity: Rarity.FOUR_STARS,
  Type: WeaponType.GAUNTLETS,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Commando_of_Conviction: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Commando_of_Conviction.webp',
  Rarity: Rarity.FOUR_STARS,
  Type: WeaponType.SWORD,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Dauntless_Evernight: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Dauntless_Evernight.webp',
  Rarity: Rarity.FOUR_STARS,
  Type: WeaponType.BROADBLADE,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Endless_Collapse: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Endless_Collapse.webp',
  Rarity: Rarity.FOUR_STARS,
  Type: WeaponType.SWORD,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Fables_of_Wisdom: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Fables_of_Wisdom.webp',
  Rarity: Rarity.FOUR_STARS,
  Type: WeaponType.SWORD,
  MainStatistic: {
    Type: StatType.ATTACK,
...
export const Fusion_Accretion: Weapon = {
  ...
  Level: 90,
  Icon: 'Weapon_Fusion_Accretion.webp',
  Rarity: Rarity.FOUR_STARS,
  Type: WeaponType.RECTIFIER,
  MainStatistic: {
    Type: StatType.ATTACK,
